...
(  ___  )(  ____ \\__   __/(  ___  )(  ____ )( (    /|(  ___  )|\     /|\__   __/
| (   ) || (    \/   ) (   | (   ) || (    )||  \  ( || (   ) || )   ( |   ) (
| (___) || (_____    | |   | (___) || (____)||   \ | || (___) || |   | |   | |
|  ___  |(_____  )   | |   |  ___  ||     __)| (\ \) ||  ___  || |   | |   | |
| (   ) |      ) |   | |   | (   ) || (\ (   | | \   || (   ) || |   | |   | |
| )   ( |/\____) |   | |   | )   ( || ) \ \__| )  \  || )   ( || (___) |   | |
|/     \|\_______)   )_(   |/     \||/   \__/|/    )_)|/     \|(_______)   )_(
...
// File: contracts/AstarBase_dummy.sol
pragma solidity >=0.7.0;
...
contract Astarnaut is ERC721Enumerable, Ownable {
    using Strings for uint256;
